...
namespace Chohuatl.CategoriasN
{
	...
	public partial class ConversacionN : ContentPage
	{
		public ConversacionN ()
		{
			InitializeComponent ();
            Imagenes();
        }
